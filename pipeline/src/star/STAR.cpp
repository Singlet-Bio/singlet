...
// duplicate-symbol conflicts.  singlify forks a child process and calls
// this function directly, so STAR's internal exit() calls only terminate
// the child, not the parent pileup process.
