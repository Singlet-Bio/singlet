...
#
# Tests need a real singlify pipeline output because the whole point of
...
# at test time:
#
#   1. Environment variable SINGLIFY_TEST_FIXTURE_DIR takes precedence.
...
fixture_dir <- function() {
    env <- Sys.getenv("SINGLIFY_TEST_FIXTURE_DIR")
