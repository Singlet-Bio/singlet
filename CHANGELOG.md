...
- **C++ test suite**: 91 unit tests covering all pileup modules (codec, cell calling, ATAC, ADT, species, nonhost, export, spatial, protocol detection, UMI dedup, bloom filter, velocity)
...
- **Python tests**: 569 total (up from 205 at cycle 184, 97% core coverage)
