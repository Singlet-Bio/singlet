...
| **Compression** | SinglePress format — ~10× vs gzipped MTX |
...
| **Preprocessing** | Full FASTQ→.spz pipeline (simpleaf + piscem) |
...
│       └── _export.py          # Count matrix → .spz export
├── tests/
├── docs/
└── pyproject.toml
```
