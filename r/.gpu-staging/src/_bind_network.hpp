...
//   hdwgcna_cpp — wraps singlet::gpu::network::run_hdwgcna
//
// Input format:
...
// Wraps singlet::gpu::network::run_hdwgcna.
//
// Returns: Rcpp::List{
        ...
        std::string resource)
{
    ...
    singlet::gpu::network::HdWGCNAResult res;
    try {
        res = singlet::gpu::network::run_hdwgcna(d_expr, n_genes, n_cells, cfg, stream);
