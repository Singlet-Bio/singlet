...
//   cellchat_cpp — wraps singlet::gpu::comm::run_cellchat
//
// Input format:
...
// Wraps singlet::gpu::comm::run_cellchat.
//
// Returns: Rcpp::List{
        ...
        std::string resource)
{
    ...
    singlet::gpu::core::DeviceMemory<int> d_ct(n_cells);
    {
    ...
    singlet::gpu::comm::CellChatResult res;
    try {
        res = singlet::gpu::comm::run_cellchat(
