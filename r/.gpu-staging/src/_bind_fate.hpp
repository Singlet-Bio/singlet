...
//   cospar_cpp      — wraps singlet::gpu::fate::run_cospar
//   cellrank2_cpp   — wraps singlet::gpu::fate::run_cellrank2
//   palantir_cpp    — wraps singlet::gpu::fate::run_palantir
//
...
// Wraps singlet::gpu::fate::run_cospar.
//
// Parameters:
        ...
        std::string resource)
{
    ...
    singlet::gpu::core::DeviceMemory<int> d_tp(n_cells), d_cl;
    {
        ...
        try {
            ...
            if (!h_cl.empty()) {
                d_cl = singlet::gpu::core::DeviceMemory<int>(n_cells);
    ...
    singlet::gpu::fate::CosparConfig cfg;
    cfg.n_fates    = n_fates;
    ...
    singlet::gpu::fate::CosparResult res;
    try {
        res = singlet::gpu::fate::run_cospar(
...
// Wraps singlet::gpu::fate::run_cellrank2.
//
// Parameters:
        ...
        std::string resource)
{
    ...
    try {
        res = singlet::gpu::fate::run_cellrank2(d_T, d_term, n_cells, n_term, cfg, stream);
    } catch (const std::exception& e) {
...
// Wraps singlet::gpu::fate::run_palantir.
//
// Parameters:
//   expression              — dgCMatrix [genes × cells], log-normalized GEX
        ...
        std::string resource)
{
    ...
    try {
        res = singlet::gpu::fate::run_palantir(d_expr, n_genes, n_cells, cfg, stream);
    } catch (const std::exception& e) {
