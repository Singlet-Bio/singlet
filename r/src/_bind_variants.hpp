...
//   call_variants_cpp — wraps singlet::gpu::variants::call_variants
//
...
// ---------------------------------------------------------------------------
inline singlet::gpu::variants::LdPanelCsr
r_list_to_ld_panel(const Rcpp::List& panel, int expected_n_snps, int chr_idx)
{
    ...
    singlet::gpu::variants::LdPanelCsr lp;
        ...
        std::string         resource)
{
    ...
    if (max_chr >= singlet::gpu::variants::MAX_CHROMOSOMES)
        Rcpp::stop("call_variants_cpp: chromosome index %d exceeds MAX_CHROMOSOMES (%d).",
                   max_chr, singlet::gpu::variants::MAX_CHROMOSOMES);
    ...
    std::vector<int> chr_start(singlet::gpu::variants::MAX_CHROMOSOMES, n_snps);
    std::vector<int> chr_end  (singlet::gpu::variants::MAX_CHROMOSOMES, 0);
    ...
    std::vector<singlet::gpu::variants::LdPanelCsr> ld_vec;
    ...
    // ── Run kernel ─────────────────────────────────────────────────────────────
    singlet::gpu::variants::MonopogenResult res;
    try {
        res = singlet::gpu::variants::call_variants(
