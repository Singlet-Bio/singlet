...
//   milo_cpp — wraps singlet::gpu::abundance::run_milo
//
// Input format:
...
// Wraps singlet::gpu::abundance::run_milo.
//
// Returns: Rcpp::List{
        ...
        std::string resource)
{
    ...
    singlet::gpu::core::DeviceMemory<int> d_don(n_cells), d_cnd(n_donors);
    {
    ...
    singlet::gpu::abundance::MiloResult res;
    try {
        res = singlet::gpu::abundance::run_milo(
