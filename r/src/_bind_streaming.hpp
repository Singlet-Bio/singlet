...
//   streaming_pipeline_run_cpp  — wraps singlet::gpu::streaming::run_pipeline
//
        ...
        int                   nmf_factors)
{
    ...
    // Run pipeline
    singlet::gpu::streaming::PipelineResult res;
    try {
        res = singlet::gpu::streaming::run_pipeline(cfg, stream);
