...
//   flash_deconv_cpp — wraps singlet::gpu::spatial::flash_deconv
//   stagate_fit_cpp  — wraps singlet::gpu::spatial::stagate_fit (model stub)
//   cell2fate_fit_cpp — wraps singlet::gpu::spatial::cell2fate_fit
//   cell2fate_predict_cpp — wraps singlet::gpu::spatial::cell2fate_predict
//
// FlashDeconv:
        ...
        int                  seed)
{
    ...
    singlet::gpu::core::DeviceCSC d_spot, d_ref;
    ...
    singlet::gpu::core::DeviceMemory<int> d_labels(n_ref);
    ...
    singlet::gpu::core::DeviceMemory<float> d_coords(n_spots * 2);
    ...
    singlet::gpu::spatial::FlashDeconvResult res;
    try {
        res = singlet::gpu::spatial::flash_deconv(
...
// ---------------------------------------------------------------------------
// [[Rcpp::export]]
inline Rcpp::XPtr<singlet::gpu::spatial::StagateModel>
stagate_fit_cpp(
        Rcpp::S4            dgc,
        Rcpp::NumericMatrix coords,
        int                 n_latent,
        ...
        int                 seed)
{
    ...
    singlet::gpu::core::DeviceMemory<float> d_coords(n_cells * 2);
    ...
    auto* model = new singlet::gpu::spatial::StagateModel();
    try {
        *model = singlet::gpu::spatial::stagate_fit(d, d_coords, n_cells, cfg, stream);
    } catch (const std::exception& e) {
        delete model;
    ...
    return Rcpp::XPtr<singlet::gpu::spatial::StagateModel>(model, true);
}
...
inline Rcpp::NumericMatrix stagate_predict_cpp(
        ...
        SEXP     model_ptr)
{
    Rcpp::XPtr<singlet::gpu::spatial::StagateModel> model(model_ptr);
    if (!model)
    ...
    singlet::gpu::spatial::StagatePredictResult res;
    try {
        res = singlet::gpu::spatial::stagate_predict(d, *model, n_cells, stream);
    } catch (const std::exception& e) {
...
// ---------------------------------------------------------------------------
// [[Rcpp::export]]
inline Rcpp::XPtr<singlet::gpu::spatial::Cell2fateModel>
cell2fate_fit_cpp(
        Rcpp::S4            spliced_dgc,
        ...
        int                 seed)
{
    ...
    singlet::gpu::core::DeviceCSC d_s, d_u;
    ...
    singlet::gpu::spatial::Cell2fateConfig cfg;
    cfg.n_latent = n_latent;
    cfg.n_epochs = n_epochs;
    cfg.lr       = static_cast<float>(lr);
    cfg.seed     = static_cast<uint64_t>(seed);

    auto* model = new singlet::gpu::spatial::Cell2fateModel();
    try {
        *model = singlet::gpu::spatial::cell2fate_fit(d_s, d_u, n_cells, cfg, stream);
    } catch (const std::exception& e) {
        delete model;
    ...
    return Rcpp::XPtr<singlet::gpu::spatial::Cell2fateModel>(model, true);
}
...
inline Rcpp::List cell2fate_predict_cpp(
        ...
        int      n_states)
{
    Rcpp::XPtr<singlet::gpu::spatial::Cell2fateModel> model(model_ptr);
    if (!model)
    ...
    singlet::gpu::spatial::Cell2fatePredictConfig pcfg;
    pcfg.n_states = n_states;

    singlet::gpu::spatial::Cell2fatePredictResult res;
    try {
        res = singlet::gpu::spatial::cell2fate_predict(d_s, d_u, *model, n_cells, pcfg, stream);
    } catch (const std::exception& e) {
