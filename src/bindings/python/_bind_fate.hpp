...
//   - cospar        (cycle 41) singlet::gpu::fate::run_cospar
//   - cellrank2     (cycle 43) singlet::gpu::fate::run_cellrank2
//   - palantir      (cycle 45) singlet::gpu::fate::run_palantir
//
...
struct PyCosparResult {
    ...
    std::vector<singlet::gpu::core::DeviceMemory<float>> transition_maps;
...
struct PyPalantirResult {
    ...
    singlet::gpu::core::DeviceMemory<float> eigenvectors_dev;  // k_eig × n_cells
...
inline void bind_fate(py::module_& m) {
    ...
    m.def("cospar",
           ...
           uint64_t   seed) -> std::shared_ptr<PyCosparResult>
        {
            ...
            singlet::gpu::fate::CosparResult r =
                singlet::gpu::fate::run_cospar(
                    pz,
    ...
    m.def("cellrank2",
           ...
           uint64_t   seed) -> std::shared_ptr<PyCellRank2Result>
        {
            ...
            singlet::gpu::io::PzDeviceMatrix* pz_ptr = nullptr;
            singlet::gpu::io::PzDeviceMatrix pz;
            if (!mat_obj.is_none()) {
                auto& py_csc = mat_obj.cast<PyDeviceCsc&>();
                pz.mat = singlet::gpu::core::DeviceCSC::from_device_ptrs(
            ...
            singlet::gpu::fate::CellRank2Result r =
                singlet::gpu::fate::run_cellrank2(
    ...
    m.def("palantir",
           ...
           uint64_t   seed) -> std::shared_ptr<PyPalantirResult>
        {
            ...
            singlet::gpu::fate::PalantirResult r =
                singlet::gpu::fate::run_palantir(
