...
//   - milo  (cycle 47) singlet::gpu::abundance::run_milo
//
...
// ---------------------------------------------------------------------------
struct PyMiloResult {
    singlet::gpu::core::DeviceMemory<float> log_fc;          // [n_nh]
    singlet::gpu::core::DeviceMemory<float> se;              // [n_nh]
    singlet::gpu::core::DeviceMemory<float> p_value;         // [n_nh]
    singlet::gpu::core::DeviceMemory<float> fdr;             // [n_nh]
    singlet::gpu::core::DeviceMemory<int>   nh_index_cells;  // [n_nh]
    singlet::gpu::core::DeviceMemory<int>   nh_valid;        // [n_nh]
    singlet::gpu::core::DeviceMemory<float> nh_counts;       // [n_nh × n_donors]
...
inline void bind_abundance(py::module_& m) {
    ...
    m.def("milo",
           ...
           uint64_t seed) -> std::shared_ptr<PyMiloResult>
        {
            ...
            singlet::gpu::abundance::MiloConfig cfg;
            cfg.k                   = k;
            ...
            singlet::gpu::abundance::MiloResult r =
                singlet::gpu::abundance::run_milo(
