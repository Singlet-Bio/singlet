...
//   - cellchat  (cycle 37) singlet::gpu::comm::run_cellchat
//
...
struct PyCellChatResult {
    singlet::gpu::core::DeviceMemory<float> comm_prob;       // [n_lr × n_types²]
    singlet::gpu::core::DeviceMemory<float> p_values;        // [n_lr × n_types²]
    singlet::gpu::core::DeviceMemory<float> pathway_activity;// [n_pathways × n_types²]
...
inline void bind_comm(py::module_& m) {
    ...
    m.def("cellchat",
           ...
           uint64_t seed) -> std::shared_ptr<PyCellChatResult>
        {
            ...
            singlet::gpu::comm::CellChatResult r =
                singlet::gpu::comm::run_cellchat(
                    pz,
