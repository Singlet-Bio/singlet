...
"""
singlet.gpu.enrichment.progeny — GPU-native PROGENy pathway activity scoring.
    ...
    *,
    ...
    if not os.path.exists(weights_tsv):
        raise FileNotFoundError(
            ...
            "`singlet.gpu.enrichment.progeny.download_progeny_weights()`."
        )
    ...
    try:
        ...
        raise ImportError(
            "singlet.gpu.enrichment.run_progeny requires cupy.  "
            f"Original error: {e}"
        )
