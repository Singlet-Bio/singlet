...
3,220+ samples • 1,378 successful • 3.98M cells • 8 species • 36 tissues • 40 cell types • 29 protocols • 8.7× .1pz compression
...
singlet.summary()
# → 3,220+ samples (1,378 SUCCESS) • 8 species • 29 protocols • 36 tissues • 40 cell types • 3.98M cells
...
| Feature | Details |
|---------|---------|
| **Catalog** | Browse 3,220+ samples by organism, tissue, cell type, protocol, status, quality tier |
