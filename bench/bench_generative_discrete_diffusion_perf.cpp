...
//
// Performance benchmark: singlet::gpu::generative::train_discrete_diffusion
//
...
singlet::gpu::bench::RefResult run_no_sota_ref()
{
...
int main()
{
    ...
    for (int i = 0; i < kWarmup; ++i) {
        auto res = singlet::gpu::generative::train_discrete_diffusion(mat, cfg, stream);
        cudaStreamSynchronize(stream);
        (void)res;
    }
