...
//
// Performance benchmark: singlet::gpu::atac::chromvar vs chromVAR R.
//
...
singlet::gpu::core::DeviceCSC make_atac_csc(
...
singlet::gpu::core::DeviceCSC make_motif_csc(
...
singlet::gpu::core::DeviceMemory<float> upload_f32(
...
singlet::gpu::bench::RefResult run_chromvar_reference(
        const singlet::gpu::core::DeviceCSC& accessibility,
        const singlet::gpu::core::DeviceCSC& motif_in_peak,
        const singlet::gpu::core::DeviceMemory<float>& peak_gc,
...
int main()
{
    ...
    std::printf("[chromvar_bench] Building ATAC CSC %d peaks × %d cells...\n",
                n_peaks, n_cells);
    singlet::gpu::core::DeviceCSC accessibility =
    ...
    std::printf("[chromvar_bench] Building motif-in-peak CSC %d motifs × %d peaks...\n",
                kNMotifs, n_peaks);
    singlet::gpu::core::DeviceCSC motif_in_peak =
    ...
    for (int i = 0; i < kWarmup; ++i) {
        auto res = singlet::gpu::atac::chromvar(
