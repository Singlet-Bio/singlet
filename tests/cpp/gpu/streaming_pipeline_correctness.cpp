...
//
// Correctness harness for singlet::gpu::streaming::run_pipeline.
//
...
/// Known cell count for GSM4037629 (updated 2026-04-14: singlet v0.3 called 20866 cells).
...
// ---------------------------------------------------------------------------
std::vector<float> device_to_host_vec(const singlet::gpu::core::DeviceMemory<float>& dm)
{
...
// ---------------------------------------------------------------------------
std::vector<int> device_to_host_int_vec(const singlet::gpu::core::DeviceMemory<int>& dm)
{
...
// Uses singlet::gpu::io::write_pz (io/write_pz.h).
// ---------------------------------------------------------------------------
#if 1
                          ...
                          const std::string& gene_prefix = "GENE")
{
    ...
    singlet::gpu::io::write_pz(path, n_rows, n_cols, nnz,
...
// ---------------------------------------------------------------------------
singlet::gpu::streaming::PipelineConfig gsm_config(int chunk_cols = kDefaultChunkCols)
{
