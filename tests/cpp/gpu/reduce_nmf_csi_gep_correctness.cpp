...
//
// Correctness harness for singlet::gpu::reduce::nmf::csi_gep.
//
...
namespace singlet::gpu { namespace reduce { namespace nmf {
...
protected:
    void SetUp() override {
        ...
        try {
            ctx_ = std::make_unique<singlet::gpu::core::GPUContext>();
    ...
    std::unique_ptr<singlet::gpu::core::GPUContext> ctx_;
};
...
TEST_F(CsiGepTest, CsiGep_TinySynthetic_VsPython) {
    ...
    singlet::gpu::core::DeviceCSC d_csc = upload_csc(h, stream_);
    ...
    singlet::gpu::reduce::nmf::CsiGepResult result =
        singlet::gpu::reduce::nmf::csi_gep(*ctx_, d_csc, cfg);
...
TEST_F(CsiGepTest, CsiGep_GSM4037629_RealData) {
    ...
    singlet::gpu::core::DeviceCSC d_csc =
        singlet::gpu::io::load_pz_device(kGsmExonPath, stream_);
    cudaStreamSynchronize(stream_);
...
TEST_F(CsiGepTest, CsiGep_Determinism_BitIdentical) {
    ...
    // First run.
    singlet::gpu::core::DeviceCSC d_csc1 = upload_csc(h, stream_);
    singlet::gpu::reduce::nmf::CsiGepResult r1 =
        singlet::gpu::reduce::nmf::csi_gep(*ctx_, d_csc1, cfg);
    cudaStreamSynchronize(stream_);
    ...
    singlet::gpu::core::DeviceCSC d_csc2 = upload_csc(h, stream_);
    singlet::gpu::reduce::nmf::CsiGepResult r2 =
        singlet::gpu::reduce::nmf::csi_gep(*ctx_, d_csc2, cfg);
    cudaStreamSynchronize(stream_);
...
// =============================================================================
//
// Smoke test that the cycle 5 NMF adapter (`singlet::gpu::reduce::nmf::fit`) is
...
TEST_F(CsiGepTest, CsiGep_ReusesCycle5NMF) {
    ...
    singlet::gpu::reduce::nmf::NmfResult nmf_result =
        singlet::gpu::reduce::nmf::fit(*ctx_, d_csc, nmf_cfg);
