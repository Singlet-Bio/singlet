...
//
// Correctness harness for singlet::gpu::de::wilcoxon_de.
//
...
TEST_F(WilcoxonTest, Wilcoxon_TinyPlanted_TopMarkersJaccard) {
    ...
    cfg.top_n = kTopN;
    singlet::gpu::de::WilcoxonResult result =
        singlet::gpu::de::wilcoxon_de(d_mat, d_labels, kTinyClusters, cfg, stream_);
...
TEST_F(WilcoxonTest, Wilcoxon_GSM4037629_RealDataPlanted) {
    ...
    cfg.top_n = kTopN;
    singlet::gpu::de::WilcoxonResult result =
        singlet::gpu::de::wilcoxon_de(d_mat, d_labels, n_clusters, cfg, stream_);
...
TEST_F(WilcoxonTest, Wilcoxon_DeterminismFlag_BitIdentical) {
    ...
    singlet::gpu::de::WilcoxonResult r1 =
        singlet::gpu::de::wilcoxon_de(d_mat, d_labels, kTinyClusters, cfg, stream_);
    singlet::gpu::de::WilcoxonResult r2 =
        singlet::gpu::de::wilcoxon_de(d_mat, d_labels, kTinyClusters, cfg, stream_);
...
TEST_F(WilcoxonTest, Wilcoxon_EdgeCase_EmptyCluster) {
    ...
    singlet::gpu::de::WilcoxonResult result;
    ASSERT_NO_THROW(
        result = singlet::gpu::de::wilcoxon_de(
...
TEST_F(WilcoxonTest, Wilcoxon_EdgeCase_SingleCluster) {
    ...
    singlet::gpu::de::WilcoxonResult result;
    ASSERT_NO_THROW(
        result = singlet::gpu::de::wilcoxon_de(d_mat, d_labels, 1, cfg, stream_));
...
TEST_F(WilcoxonTest, Test83_RealDataSized_PostNormalize_NoCrash) {
    ...
    singlet::gpu::preprocess::LogNormConfig ln_cfg;
    (void)singlet::gpu::preprocess::log_normalize(d_mat, ln_cfg, stream_);
    ...
    singlet::gpu::core::DeviceMemory<int32_t> d_labels(static_cast<size_t>(kCells));
    cudaMemcpyAsync(d_labels.get(), lbl.data(),
    ...
    singlet::gpu::de::WilcoxonConfig w_cfg;
    w_cfg.top_n = 50;

    singlet::gpu::de::WilcoxonResult result;
    ASSERT_NO_THROW({
        result = singlet::gpu::de::wilcoxon_de(d_mat, d_labels, kGroups, w_cfg, stream_);
