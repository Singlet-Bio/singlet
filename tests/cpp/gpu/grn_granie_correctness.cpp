...
//
// Correctness harness for singlet::gpu::grn::granie.
//
...
// --- singlet::gpu::core::Handles compat ---
...
} } // namespace singlet::gpu::grn

// --- singlet::gpu::io compat ---
...
// Add a free-standing helper in the singlet::gpu::core namespace.
namespace singlet::gpu { namespace core {
...
// The test calls: singlet::gpu::core::DeviceCSC::free(obj, stream)
...
TEST_F(GRaNIETest, GRaNIE_TinySynthetic_VsR) {
    ...
    DevCSC gex_csc = singlet::gpu::io::host_dense_to_device_csc(
        gex_genes_cells.data(), kTinyGenes, kTinyCells, stream_);
    DevCSC peaks_csc = singlet::gpu::io::host_dense_to_device_csc(
    ...
    singlet::gpu::grn::GRaNIEResult result =
        singlet::gpu::grn::compute_granie(
            gex_csc,
            peaks_csc,
    ...
    singlet::gpu::grn::GRaNIEResult::free(result, stream_);
...
TEST_F(GRaNIETest, GRaNIE_GSM_RealMultiome) {
    ...
    singlet::gpu::core::DeviceCSC gex_csc =
        singlet::gpu::io::load_pz_device(kGsmGexPath, handles_, stream_);

    // Load peaks (peaks × cells, from fragments.1pz)
    singlet::gpu::core::DeviceCSC peaks_csc =
        singlet::gpu::io::load_pz_device(kGsmPeaksPath, handles_, stream_);
