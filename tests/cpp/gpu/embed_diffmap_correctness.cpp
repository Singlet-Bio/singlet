...
TEST(DiffmapTest, Diffmap_LinearChain_PrincipalComponentMonotonic)
{
    ...
    singlet::gpu::embed::DiffmapConfig cfg;
    cfg.n_comps = 10;
    cfg.t       = 1;

    auto res = singlet::gpu::embed::diffmap(knn, cfg);
