...
//
// Correctness harness for singlet::gpu::variants::monopogen.
//
...
namespace singlet::gpu { namespace variants {
...
} }  // namespace singlet::gpu::variants
...
TEST(Monopogen, TinySynthetic_VsPython) {
    ...
    singlet::gpu::core::DeviceCSC d_ad = upload_csc(data.snp_ad, stream);
    singlet::gpu::core::DeviceCSC d_dp = upload_csc(data.snp_dp, stream);

    // Load LD panel from TSV.
    singlet::gpu::variants::LdPanel ld_panel =
        singlet::gpu::variants::load_ld_panel_tsv(kLdPanelPath, kTinySNPs);

    singlet::gpu::variants::MonopogenConfig cfg{};
    cfg.min_depth    = kMinDepth;
    cfg.seed         = kSeed;
    cfg.with_ld      = true;
    cfg.fdr_threshold = 0.05f;

    singlet::gpu::variants::MonopogenResult result =
        singlet::gpu::variants::run_monopogen(
...
TEST(Monopogen, GSM_RealData) {
    ...
    singlet::gpu::io::PzLoader loader;
    singlet::gpu::core::DeviceCSC d_ad =
        loader.load(kGsmSnpAdPath, stream);
    singlet::gpu::core::DeviceCSC d_dp =
    ...
    singlet::gpu::variants::LdPanel empty_ld{};
...
TEST(Monopogen, LdRefinement_ReducesFalsePositives) {
    ...
    singlet::gpu::core::DeviceCSC d_ad_no = upload_csc(data.snp_ad, stream);
    singlet::gpu::core::DeviceCSC d_dp_no = upload_csc(data.snp_dp, stream);
    singlet::gpu::core::DeviceCSC d_ad_ld = upload_csc(data.snp_ad, stream);
    singlet::gpu::core::DeviceCSC d_dp_ld = upload_csc(data.snp_dp, stream);

    singlet::gpu::variants::MonopogenConfig cfg_no{};
    ...
    singlet::gpu::variants::LdPanel empty_ld{};
    singlet::gpu::variants::MonopogenResult result_no =
        singlet::gpu::variants::run_monopogen(
            d_ad_no, d_dp_no, empty_ld, cfg_no, stream);
    ASSERT_EQ(cudaStreamSynchronize(stream), cudaSuccess);

    singlet::gpu::variants::MonopogenConfig cfg_ld = cfg_no;
    cfg_ld.with_ld = true;
    ...
    singlet::gpu::variants::MonopogenResult result_ld =
        singlet::gpu::variants::run_monopogen(
