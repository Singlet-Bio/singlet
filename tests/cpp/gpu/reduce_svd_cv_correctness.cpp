...
singlet::gpu::io::PzDeviceMatrix upload_with_host(const SynCSC& c)
{
...
singlet::gpu::reduce::svd::SvdConfig make_cfg(uint64_t seed = 0xC115BEEFU,
                                              float holdout = 0.10f)
{
...
TEST(SvdCvTest, Smoke_200x500)
{
    ...
    singlet::gpu::reduce::svd::CVSVDResult cv =
        singlet::gpu::reduce::svd::speckled_cv(pz, cfg, k_vals);
...
TEST(SvdCvTest, Determinism_SameSeed)
{
    ...
    singlet::gpu::reduce::svd::CVSVDResult cv1 =
        singlet::gpu::reduce::svd::speckled_cv(pz, cfg, k_vals);
    singlet::gpu::reduce::svd::CVSVDResult cv2 =
        singlet::gpu::reduce::svd::speckled_cv(pz, cfg, k_vals);
