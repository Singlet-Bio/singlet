...
# CYCLE-183 iter-2: re-verify core/sparse_eigensolver after largest-eigenvalue fix.
# Fix: negate M in Rayleigh-Ritz before cusolverDnSsygvd (ARPACK sign-flip trick).
# CYCLE-182 iter-1 (job 372420): 4/5 FAIL — smallest vs largest convention.

#SBATCH --job-name=sparse_eig_c183
...
#SBATCH --output=/mnt/home/debruinz/Singlet-AI/singlet-gpu/state/cycle183_sparse_eig_%j.log
...
BUILD_DIR=/mnt/projects/debruinz_project/singlet-gpu/build/cycle183_sparse_eig
SRC_DIR=/mnt/home/debruinz/Singlet-AI/singlet-gpu

echo "=== CYCLE-183: core/sparse_eigensolver correctness verify (largest-eig fix) ==="
