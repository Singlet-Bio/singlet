...
# CYCLE-244: cuda-memcheck (compute-sanitizer) wrapper for the
# pseudobulk min_cells_filter CUDA crash (CYCLE-211).
#
# After CYCLE-243 retracted the apeglm hypothesis (the kernel HAS
...
#
# Output goes to state/cycle244_pseudobulk_memcheck_${SLURM_JOB_ID}.log.
# Look for lines like:
...
#SBATCH --job-name=sg_c244_pseudobulk_memcheck
...
#SBATCH --output=/mnt/home/debruinz/Singlet-AI/singlet-gpu/state/cycle244_pseudobulk_memcheck_%j.log
...
export SKBUILD_BUILD_DIR=/mnt/projects/debruinz_project/singlet-gpu/build/cycle244_skbuild
...
cat /mnt/home/debruinz/Singlet-AI/singlet-gpu/state/cycle244_sanitizer_${SLURM_JOB_ID}.log 2>&1 | head -80
