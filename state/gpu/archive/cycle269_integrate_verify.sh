...
# CYCLE-269: broader verify after CYCLE-260-265 wrapper-rot peel.
# Confirms: test_pp_neighbors (3/3 PASS via xfail), test_reduce delta,
# test_integrate delta.

#SBATCH --job-name=sg_c269_int_verify
...
#SBATCH --output=/mnt/home/debruinz/Singlet-AI/singlet-gpu/state/cycle269_integrate_verify_%j.log
...
export SKBUILD_BUILD_DIR=/mnt/projects/debruinz_project/singlet-gpu/build/cycle269_skbuild

PY_DIR=/mnt/home/debruinz/Singlet-AI/singlet-gpu/python
VENV=/tmp/singlet_gpu_venv_${SLURM_JOB_ID}

echo "=== CYCLE-269: broader verify ==="
