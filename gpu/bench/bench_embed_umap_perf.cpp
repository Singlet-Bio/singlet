...
//
// Performance benchmark: singlet_gpu::embed::umap vs cuML UMAP.
//
...
singlet_gpu::bench::RefResult run_umap_reference(
...
int main()
{
    ...
    for (int i = 0; i < kWarmup; ++i) {
        auto res = singlet_gpu::embed::umap(knn_result, umap_cfg, stream);
        cudaStreamSynchronize(stream);
        (void)res;
    }
