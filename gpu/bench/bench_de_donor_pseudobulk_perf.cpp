...
//
// Performance benchmark: singlet_gpu::de::donor_pseudobulk_de (cycle 15)
...
singlet_gpu::core::DeviceCSC make_count_csc(
...
singlet_gpu::core::DeviceMemory<int> upload_labels(
        const std::vector<int>& h_labels, cudaStream_t stream)
{
    singlet_gpu::core::DeviceMemory<int> d(h_labels.size());
