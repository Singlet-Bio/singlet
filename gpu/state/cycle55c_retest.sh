#!/bin/bash
#SBATCH --job-name=sg55c_retest
#SBATCH --partition=gpu
#SBATCH --gres=gpu:tesla_v100s:1
#SBATCH --cpus-per-task=16
#SBATCH --mem=64G
#SBATCH --time=01:30:00
#SBATCH --output=/mnt/home/debruinz/Singlet-AI/singlet-gpu/state/cycle55c_retest_%j.log
...
BUILD_DIR=/dev/shm/singletgpu_retest55c_${SLURM_JOB_ID}
mkdir -p ${BUILD_DIR}
