...
# CYCLE-251: cuda-memcheck (compute-sanitizer) wrapper for the
...
#
# Output goes to state/cycle251_pca_initcheck_${SLURM_JOB_ID}.log.
# Look for lines like:
...
#SBATCH --job-name=sg_c251_pca_initcheck
...
#SBATCH --output=/mnt/home/debruinz/Singlet-AI/singlet-gpu/state/cycle251_pca_initcheck_%j.log
...
export SKBUILD_BUILD_DIR=/mnt/projects/debruinz_project/singlet-gpu/build/cycle251_skbuild
...
#   --tool initcheck       — detect OOB / unaligned / leaked allocations
...
compute-sanitizer \
    ...
    --print-limit 4 \
    --log-file=/mnt/home/debruinz/Singlet-AI/singlet-gpu/state/cycle251_sanitizer_${SLURM_JOB_ID}.log \
    python -m pytest \
...
cat /mnt/home/debruinz/Singlet-AI/singlet-gpu/state/cycle251_sanitizer_${SLURM_JOB_ID}.log 2>&1 | head -80
