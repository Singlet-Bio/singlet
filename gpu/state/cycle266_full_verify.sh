...
# CYCLE-266: broader verify after CYCLE-260-265 wrapper-rot peel.
# Confirms: test_pp_neighbors (3/3 PASS via xfail), test_reduce delta,
# test_integrate delta.

#SBATCH --job-name=sg_c266_full_verify
...
#SBATCH --output=/mnt/home/debruinz/Singlet-AI/singlet-gpu/state/cycle266_full_verify_%j.log
...
export SKBUILD_BUILD_DIR=/mnt/projects/debruinz_project/singlet-gpu/build/cycle266_skbuild

PY_DIR=/mnt/home/debruinz/Singlet-AI/singlet-gpu/python
VENV=/tmp/singlet_gpu_venv_${SLURM_JOB_ID}

echo "=== CYCLE-266: broader verify ==="
...
for tf in test_pp_neighbors.py test_tl_leiden.py test_tl_umap.py \
          test_tl_rank_genes_groups.py test_reduce.py test_integrate.py \
          test_velocity.py test_de_pseudobulk.py; do
  echo ""
  echo "================================================================"
  echo "--- pytest $tf ---"
  echo "================================================================"
