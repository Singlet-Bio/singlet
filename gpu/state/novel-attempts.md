...
- **Action**: Re-run on a sample with snp_dp.1pz (any GSM processed with `--snps VCF`). Check singlify pipeline quant directory. Also install Rscript + scran on g001 for proper scran reference comparison.
