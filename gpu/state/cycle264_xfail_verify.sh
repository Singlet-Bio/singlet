...
# CYCLE-264: verify knn_graph wrapper fix.
#
# CYCLE-257 unblocked PCA; CYCLE-264 fixes the next-largest wrapper-rot
...
#SBATCH --job-name=sg_c264_xfail_graph_verify
...
#SBATCH --output=/mnt/home/debruinz/Singlet-AI/singlet-gpu/state/cycle264_xfail_verify_%j.log
...
export SKBUILD_BUILD_DIR=/mnt/projects/debruinz_project/singlet-gpu/build/cycle264_skbuild

PY_DIR=/mnt/home/debruinz/Singlet-AI/singlet-gpu/python
VENV=/tmp/singlet_gpu_venv_${SLURM_JOB_ID}

echo "=== CYCLE-264: knn_graph wrapper signature fix verify ==="
...
echo "--- SUMMARY ---"
echo "================================================================"
echo "If knn_graph TypeErrors disappear: CYCLE-264 fix is durable."
