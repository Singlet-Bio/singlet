...
# CYCLE-263: verify knn_graph wrapper fix.
#
# CYCLE-257 unblocked PCA; CYCLE-263 fixes the next-largest wrapper-rot
...
#SBATCH --job-name=sg_c263_knn_graph_verify
...
#SBATCH --output=/mnt/home/debruinz/Singlet-AI/singlet-gpu/state/cycle263_knn_cache_verify_%j.log
...
export SKBUILD_BUILD_DIR=/mnt/projects/debruinz_project/singlet-gpu/build/cycle263_skbuild

PY_DIR=/mnt/home/debruinz/Singlet-AI/singlet-gpu/python
VENV=/tmp/singlet_gpu_venv_${SLURM_JOB_ID}

echo "=== CYCLE-263: knn_graph wrapper signature fix verify ==="
...
echo "--- SUMMARY ---"
echo "================================================================"
echo "If knn_graph TypeErrors disappear: CYCLE-263 fix is durable."
