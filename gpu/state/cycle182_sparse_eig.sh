...
# CYCLE-182: build + run core/sparse_eigensolver correctness ctest.
# Phase D Step 1 of CYCLE-159.1 (sparse eigensolver rewrite for diffmap+dpt).

#SBATCH --job-name=sparse_eig_c182
...
#SBATCH --output=/mnt/home/debruinz/Singlet-AI/singlet-gpu/state/cycle182_sparse_eig_%j.log
...
BUILD_DIR=/mnt/projects/debruinz_project/singlet-gpu/build/cycle182_sparse_eig
SRC_DIR=/mnt/home/debruinz/Singlet-AI/singlet-gpu

echo "=== CYCLE-182: core/sparse_eigensolver correctness verify ==="
...
# Copy scipy reference into the expected /tmp path on this node, since the
# scipy ref npz was generated on the login node and lives only there.
echo ""
...
if [ -f /mnt/home/debruinz/Singlet-AI/singlet-gpu/tests/refs/sparse_eig_medium_ref.npz ]; then
    cp /mnt/home/debruinz/Singlet-AI/singlet-gpu/tests/refs/sparse_eig_medium_ref.npz /tmp/singlet_gpu_sparse_eig_refs_tmp/sparse_eig_medium_ref.npz
...
# Run the 5 tests, one filter at a time, to get clean per-test output.
declare -a TESTS=(
    "TinyEigSymmetric"
    "ScaleSmokeMedium"
