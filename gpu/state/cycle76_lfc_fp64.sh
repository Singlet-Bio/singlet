#!/bin/bash
#SBATCH --job-name=sg_cycle76_lfc_fp64
#SBATCH --partition=gpu
#SBATCH --time=00:45:00
#SBATCH --cpus-per-task=8
#SBATCH --mem=48G
#SBATCH --gres=gpu:1
#SBATCH --output=/mnt/home/debruinz/Singlet-AI/singlet-gpu/state/cycle76_lfc_fp64_%j.log
...
BUILD_DIR=/mnt/home/debruinz/Singlet-AI/singlet-gpu/build_cycle76_verify
SRC_DIR=/mnt/home/debruinz/Singlet-AI/singlet-gpu

echo "=== Cycle 76 LFC fp64 promotion retest ==="
...
grep -E "Jaccard|Spearman|rho|LFC|PASSED|FAILED|PASS|FAIL" /tmp/tinyplanted_$SLURM_JOB_ID.txt | head -50 || true
echo ""
echo "=== TEST83 VERDICT ==="
