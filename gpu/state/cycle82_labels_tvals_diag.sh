#!/bin/bash
#SBATCH --job-name=sg_c82_labels_tvals_diag
#SBATCH --partition=gpu
#SBATCH --time=00:30:00
#SBATCH --cpus-per-task=8
#SBATCH --mem=32G
#SBATCH --gres=gpu:1
#SBATCH --output=/mnt/home/debruinz/Singlet-AI/singlet-gpu/state/cycle82_labels_tvals_diag_%j.log
...
BUILD_DIR=/mnt/home/debruinz/Singlet-AI/singlet-gpu/build_cycle82_diag
SRC_DIR=/mnt/home/debruinz/Singlet-AI/singlet-gpu

echo "=== Cycle 82: labels + t-values diagnostic ==="
...
cmake --build "$BUILD_DIR" --target de_ttest_correctness -j8 2>&1
BUILD_EXIT=$?
echo "BUILD_EXIT=$BUILD_EXIT"
[ "$BUILD_EXIT" -ne 0 ] && { echo "BUILD FAILED"; exit $BUILD_EXIT; }

echo "--- ctest: Ttest_TinyPlanted_TopMarkersJaccard only ---"
ctest --test-dir "$BUILD_DIR" -R "Ttest_TinyPlanted_TopMarkersJaccard" \
