...
PZ_SMALL="/mnt/projects/debruinz_project/singlify_pipeline/quant/scrna/GSE127/GSE127918/GSM4037629/gene_counts.1pz"
H5AD_SMALL="/dev/shm/singlet_gpu_bench_small.h5ad"

export SINGLIFY_REF_BASE=/mnt/projects/debruinz_project/cellarium/reference/
