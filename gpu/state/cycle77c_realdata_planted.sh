#!/bin/bash
#SBATCH --job-name=sg_cycle77c_realdata
#SBATCH --partition=gpu
#SBATCH --time=01:00:00
#SBATCH --cpus-per-task=8
#SBATCH --mem=48G
#SBATCH --gres=gpu:1
#SBATCH --output=/mnt/home/debruinz/Singlet-AI/singlet-gpu/state/cycle77c_realdata_planted_%j.log
...
BUILD_DIR=/mnt/home/debruinz/Singlet-AI/singlet-gpu/build_cycle77c_verify
SRC_DIR=/mnt/home/debruinz/Singlet-AI/singlet-gpu

echo "=== Cycle 77c RealDataPlanted constant-pval fix retest ==="
...
cmake --build "$BUILD_DIR" --target de_wilcoxon_correctness -j8 2>&1 | tail -15
BUILD_EXIT=$?
...
echo ""
echo "=== TinyPlanted VERDICT ==="
grep -E "PASSED|FAILED|tests passed|tests failed" \
    /tmp/tinyplanted_${SLURM_JOB_ID}.txt | tail -5 || true
