...
# Cycle 92 verify — compile the public umbrella header + cpp_minimal smoke test.

#SBATCH --job-name=sg_c92_verify
...
#SBATCH --output=/mnt/home/debruinz/Singlet-AI/singlet-gpu/state/cycle92_verify_%j.log
...
BUILD_DIR=/mnt/projects/debruinz_project/singlet-gpu/build/cycle92_umbrella
SRC_DIR=/mnt/home/debruinz/Singlet-AI/singlet-gpu

echo "=== Cycle 92 verify: public umbrella header ==="
