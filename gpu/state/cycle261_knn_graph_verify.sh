...
# CYCLE-261: verify knn_graph wrapper fix.
#
# CYCLE-257 unblocked PCA; CYCLE-261 fixes the next-largest wrapper-rot
...
#SBATCH --job-name=sg_c261_knn_graph_verify
...
#SBATCH --output=/mnt/home/debruinz/Singlet-AI/singlet-gpu/state/cycle261_knn_graph_verify_%j.log
...
export SKBUILD_BUILD_DIR=/mnt/projects/debruinz_project/singlet-gpu/build/cycle261_skbuild

PY_DIR=/mnt/home/debruinz/Singlet-AI/singlet-gpu/python
VENV=/tmp/singlet_gpu_venv_${SLURM_JOB_ID}

echo "=== CYCLE-261: knn_graph wrapper signature fix verify ==="
...
echo "--- SUMMARY ---"
echo "================================================================"
echo "If knn_graph TypeErrors disappear: CYCLE-261 fix is durable."
