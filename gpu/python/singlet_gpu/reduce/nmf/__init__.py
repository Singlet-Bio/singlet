...
"""
singlet_gpu.reduce.nmf — GPU-native NMF.
...
Python's package-vs-module precedence — `from singlet_gpu.reduce.nmf import nmf`
...
from singlet_gpu.reduce._nmf_core import (
    nmf,
    nmf_chunked,
    nmf_graph_factorize,
    NmfResult,
