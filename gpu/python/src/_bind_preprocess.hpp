...
struct PyDenseResult {
    singlet_gpu::core::DeviceDense dense;  // owns n_genes*n_cells floats
...
inline void bind_preprocess(py::module_& m) {
    ...
    m.def("scale",
           ...
           py::object stream_obj) -> py::object
        {
            ...
            auto dense = singlet_gpu::preprocess::scale(*mat.csc, mean_ptr, std_ptr, cfg, s);
    ...
    m.def("regress_out",
           ...
           py::object stream_obj) -> void
        {
            ...
            singlet_gpu::preprocess::regress_out(X, n_genes, n_cells, C_ptr, p, s);
        },
        py::arg("dense"),
        py::arg("C"),
        py::arg("p"),
