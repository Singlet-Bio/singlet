...
// ---------------------------------------------------------------------------
struct PyDDSamples {
    singlet_gpu::core::DeviceMemory<float> data;  // n_samples × n_genes, row-major
    int n_samples = 0;
    int n_genes   = 0;
...
inline void bind_generative(py::module_& m) {
    ...
    m.def("train_discrete_diffusion",
           ...
           uint64_t seed) -> py::object
        {
            ...
            auto r = singlet_gpu::generative::train_discrete_diffusion(mat, cfg, s);
    ...
    m.def("sample_discrete_diffusion",
           ...
           uint64_t seed) -> py::object
        {
            ...
            singlet_gpu::generative::DiscreteDiffusionResult cpp_model;
            ...
            singlet_gpu::generative::DiscreteDiffusionConfig cfg = model.cfg;
            cfg.seed = seed;
            ...
            auto d_samples = singlet_gpu::generative::sample_cells(cpp_model, n_samples, cfg, s);
