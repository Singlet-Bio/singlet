...
//
// Declared inside namespace singlet_gpu::python so bind_kernels.hpp can use the
// type names directly.
...
// ---------------------------------------------------------------------------
struct PyKnnResult {
    singlet_gpu::core::DeviceMemory<int>   row_offsets;
    singlet_gpu::core::DeviceMemory<int>   neighbors;
    singlet_gpu::core::DeviceMemory<float> distances;
    int n  = 0;
    int k  = 0;
...
struct PyLeidenResult {
    singlet_gpu::core::DeviceMemory<int> labels;
    int   n_clusters  = 0;
...
// ---------------------------------------------------------------------------
struct PyUmapResult {
    singlet_gpu::core::DeviceMemory<float> embedding;
    int n           = 0;
    int n_components = 0;
    cudaStream_t stream = nullptr;
};
...
struct PyClusterMarkers {
    int cluster_id = 0;
    singlet_gpu::core::DeviceMemory<int>   gene_indices;
...
struct PyRefMapResult {
    singlet_gpu::core::DeviceMemory<float> probabilities;
    singlet_gpu::core::DeviceMemory<int>   labels;
    int n_classes = 0;
    int n_cells   = 0;
    cudaStream_t stream = nullptr;
...
struct PyCelltypistModel {
    singlet_gpu::core::DeviceMemory<float> weights;
    singlet_gpu::core::DeviceMemory<float> intercepts;
...
struct PyFgseaResult {
    std::vector<singlet_gpu::gsea::PathwayResult> pathways;
};
...
struct PyHarmonyResult {
    singlet_gpu::core::DeviceMemory<float> corrected;
    int   n_iters_used  = 0;
...
struct PyVelocityPrepResult {
    singlet_gpu::core::DeviceMemory<float>   gamma;
    singlet_gpu::core::DeviceMemory<float>   gamma_se;
    singlet_gpu::core::DeviceMemory<float>   S_mean;
    singlet_gpu::core::DeviceMemory<float>   U_mean;
    singlet_gpu::core::DeviceMemory<uint8_t> filter_mask;
    singlet_gpu::core::DeviceMemory<float>   velocity;
...
struct PyClonePrediction {
    singlet_gpu::core::DeviceMemory<int>   labels;
    int                                    n_clones = 0;
    singlet_gpu::core::DeviceMemory<int>   informative_sites;
    int                                    n_informative_sites = 0;
    singlet_gpu::core::DeviceMemory<float> clone_profiles;
    singlet_gpu::core::DeviceMemory<float> per_cell_heteroplasmy;
    cudaStream_t stream = nullptr;
};
...
struct PyDonorPseudobulkResult {
    ...
    singlet_gpu::core::DeviceMemory<float> p_values;
    singlet_gpu::core::DeviceMemory<float> p_adj;
    singlet_gpu::core::DeviceMemory<float> dispersion;
    singlet_gpu::core::DeviceMemory<float> pseudobulk;
    int n_genes_passing_filter = 0;
    cudaStream_t stream = nullptr;
};
