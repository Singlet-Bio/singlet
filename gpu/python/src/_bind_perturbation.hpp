...
// To expose predict, we store the entire singlet_gpu::perturbation::PerturbGraphResult
...
struct PyPerturbGraphResult {
    singlet_gpu::perturbation::PerturbGraphResult result;
    ...
    singlet_gpu::perturbation::MLPParams          enc;
    singlet_gpu::perturbation::MLPParams          dec;
...
inline void bind_perturbation(py::module_& m) {
    ...
    .def("predict_perturbation",
           ...
           py::object stream) -> py::object
        {
            ...
            const singlet_gpu::core::DeviceCSC& qmat = *query_counts.csc;
            singlet_gpu::core::GPUContext ctx(s);
            ...
            auto d_pred = singlet_gpu::perturbation::predict_perturbation(
                self.result,
                const_cast<singlet_gpu::perturbation::MLPParams&>(self.enc),
                const_cast<singlet_gpu::perturbation::MLPParams&>(self.dec),
                qmat,
                target_pert_id,
                target_dose,
                self.cfg,
            ...
            auto holder = std::make_shared<singlet_gpu::core::DeviceMemory<float>>(
                std::move(d_pred));
            py::dict view;
    ...
    m.def("train_perturb_graph",
           ...
           uint64_t seed) -> py::object
        {
            ...
            singlet_gpu::core::GPUContext ctx(s);
            auto result = singlet_gpu::perturbation::train_perturb_graph(
