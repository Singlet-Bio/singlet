...
//   - scdrs  (cycle 50) singlet_gpu::disease::run_scdrs
//
...
struct PyScDrsResult {
    singlet_gpu::core::DeviceMemory<float> raw_score;         // [n_cells × n_diseases]
    singlet_gpu::core::DeviceMemory<float> normalized_score;  // [n_cells × n_diseases]
    singlet_gpu::core::DeviceMemory<float> p_value;           // [n_cells × n_diseases]
    singlet_gpu::core::DeviceMemory<float> fdr;               // [n_cells × n_diseases]
...
inline void bind_disease(py::module_& m) {
    ...
    m.def("scdrs",
           ...
           uint64_t   seed) -> std::shared_ptr<PyScDrsResult>
        {
            ...
            std::vector<singlet_gpu::disease::DiseaseGeneSet> gene_sets;
            ...
            singlet_gpu::disease::ScDrsResult r =
                singlet_gpu::disease::run_scdrs(
