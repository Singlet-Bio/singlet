...
//   granie_cpp — wraps singlet_gpu::grn::run_granie
//
...
// into a singlet_gpu::grn::HostCSR.
//
...
// ---------------------------------------------------------------------------
inline singlet_gpu::grn::HostCSR
        ...
        std::string          resource)
{
    ...
    // ── Upload matrices ──────────────────────────────────────────────────────
    singlet_gpu::core::DeviceCSC d_gex, d_peaks;
    ...
    // ── Run kernel ────────────────────────────────────────────────────────────
    singlet_gpu::grn::GranieResult res;
    try {
        res = singlet_gpu::grn::run_granie(d_gex, d_peaks, csr_motif, pairs_h, ctx, cfg);
