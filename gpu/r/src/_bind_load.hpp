...
//   2. Call singlet_gpu::io::load_pz(path, /*stream=*/nullptr, keep_host_pinned).
...
// Mirrors the singlify output naming convention from CLAUDE.md §Full Output.
// ---------------------------------------------------------------------------
        ...
        bool        keep_host_pinned)
{
    ...
    try {
        dev_mat = singlet_gpu::io::load_pz(pz_path,
                                           /*stream=*/nullptr,
                                           keep_host_pinned);
    ...
    Rcpp::List r_meta = Rcpp::List::create(
        ...
        Rcpp::Named("singlify_version") = meta.singlify_version,
