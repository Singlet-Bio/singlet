...
//   ssgsea_cpp   — wraps singlet_gpu::enrich::ssgsea_gpu
//   progeny_cpp  — wraps singlet_gpu::enrich::progeny_gpu
//
// ssGSEA:
        ...
        bool                  normalize)
{
    ...
    singlet_gpu::enrich::SsGseaResult res;
    try {
        res = singlet_gpu::enrich::ssgsea_gpu(d, db, cfg, stream);
        ...
        bool                  scale)
{
    ...
    singlet_gpu::core::DeviceMemory<int>   d_pg(n_entries);
    singlet_gpu::core::DeviceMemory<int>   d_pp(n_entries);
    singlet_gpu::core::DeviceMemory<float> d_pw(n_entries);
    ...
    singlet_gpu::enrich::ProgenyResult res;
    try {
        res = singlet_gpu::enrich::progeny_gpu(
