...
//   perturb_graph_fit_cpp     — wraps singlet_gpu::perturb::perturb_graph_fit
//   perturb_graph_predict_cpp — wraps singlet_gpu::perturb::perturb_graph_predict
//
// PerturbGraph:
...
// ---------------------------------------------------------------------------
// [[Rcpp::export]]
inline Rcpp::XPtr<singlet_gpu::perturb::PerturbGraphModel>
perturb_graph_fit_cpp(
        Rcpp::S4            dgc,
        ...
        int                 seed)
{
    ...
    singlet_gpu::perturb::PerturbGraphConfig cfg;
    ...
    auto* model = new singlet_gpu::perturb::PerturbGraphModel();
    try {
        *model = singlet_gpu::perturb::perturb_graph_fit(d, d_labels, n_cells, cfg, stream);
    ...
    return Rcpp::XPtr<singlet_gpu::perturb::PerturbGraphModel>(model, true);
}
...
{
    Rcpp::XPtr<singlet_gpu::perturb::PerturbGraphModel> model(model_ptr);
    if (!model)
    ...
    singlet_gpu::core::DeviceMemory<int> d_targets(n_targets);
    cudaMemcpyAsync(d_targets.get(), h_targets.data(), n_targets * sizeof(int),
                    cudaMemcpyHostToDevice, stream);
    cudaStreamSynchronize(stream);

    singlet_gpu::perturb::PerturbGraphPredictResult res;
    try {
        res = singlet_gpu::perturb::perturb_graph_predict(
