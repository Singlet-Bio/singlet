...
//   csi_gep_cpp — wraps singlet_gpu::nmf::csi_gep (cycle 28 kernel)
//
        ...
        int      seed)
{
    ...
    singlet_gpu::nmf::CsiGepConfig cfg;
    cfg.k             = k;
    cfg.n_runs        = n_runs;
    ...
    singlet_gpu::nmf::CsiGepResult res;
    try {
        res = singlet_gpu::nmf::csi_gep(d, n_genes, n_cells, cfg, stream);
