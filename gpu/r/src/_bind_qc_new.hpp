...
//   omni_doublet_score_cpp — wraps singlet_gpu::qc::omni_doublet_score
//   doublet_score_cpp      — wraps singlet_gpu::qc::doublet_score (cycle 31 kernel)
//
// OmniDoublet:
        ...
        int      seed)
{
    ...
    singlet_gpu::qc::OmniDoubletResult res;
    try {
        res = singlet_gpu::qc::omni_doublet_score(d, n_cells, cfg, stream);
        ...
        int      seed)
{
    ...
    singlet_gpu::qc::DoubletScoreResult res;
    try {
        res = singlet_gpu::qc::doublet_score(d, n_cells, cfg, stream);
    } catch (const std::exception& e) {
