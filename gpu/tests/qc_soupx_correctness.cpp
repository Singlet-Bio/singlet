...
//
// Correctness harness for singlet_gpu::qc::soupx.
//
// Tests:
...
TEST_F(SoupxTest, Soupx_Determinism_BitIdentical) {
    ...
    auto res_a = singlet_gpu::qc::soupx(pz, cfg, stream_);
    auto res_b = singlet_gpu::qc::soupx(pz, cfg, stream_);
...
TEST_F(SoupxTest, Soupx_MemoryGuard_RejectsTooLarge) {
    ...
    pz.mat.cols = 100000;
    pz.mat.nnz  = 0;
    pz.mat.values      = singlet_gpu::core::DeviceMemory<float>(1);
    pz.mat.row_indices = singlet_gpu::core::DeviceMemory<int32_t>(1);
    pz.mat.col_ptr     = singlet_gpu::core::DeviceMemory<int32_t>(100001);
