...
//
// Correctness harness for singlet_gpu::anno::reference_map (CellTypist-style).
//
...
// ---------------------------------------------------------------------------
singlet_gpu::core::DeviceDense upload_dense(
...
std::vector<int32_t> download_labels(
        const singlet_gpu::anno::RefMapResult& res, int n_cells)
{
...
std::vector<float> download_probabilities(
        const singlet_gpu::anno::RefMapResult& res,
