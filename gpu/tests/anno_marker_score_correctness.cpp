...
//
// Correctness harness for singlet_gpu::anno::marker_score.
//
...
// ---------------------------------------------------------------------------
singlet_gpu::core::DeviceCSC make_device_csc_from_dense(
...
// ---------------------------------------------------------------------------
singlet_gpu::anno::GeneSetDB make_tiny_gene_set_db(int n_sets, int genes_per_set) {
...
std::vector<float> download_scores(
        const singlet_gpu::anno::MarkerScoreResult& res,
        cudaStream_t stream)
{
...
protected:
    ...
    singlet_gpu::anno::GeneSetDB db_;
    std::vector<float> h_mat_;
    singlet_gpu::core::DeviceCSC d_mat_{};
};
...
TEST_F(MarkerScoreTest, MarkerScore_Mlm_VsDecoupleR) {
    using namespace singlet_gpu::anno;
...
TEST_F(MarkerScoreTest, MarkerScore_TikhonovRegularizer_NonSingular) {
    ...
    singlet_gpu::anno::MarkerScoreResult result;
