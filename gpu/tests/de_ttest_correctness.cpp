...
//
// Correctness harness for singlet_gpu::de::ttest_de (Welch's t-test DE).
//
...
TEST_F(TtestDE, Ttest_TinyPlanted_TopMarkersJaccard) {
    ...
    singlet_gpu::de::TtestResult result =
        singlet_gpu::de::ttest_de(d_mat, d_labels, kTinyClusters, cfg, stream_);
...
TEST_F(TtestDE, Ttest_GSM4037629_RealDataPlanted) {
    ...
    cfg.top_n = kTopN;
    singlet_gpu::de::TtestResult result =
        singlet_gpu::de::ttest_de(d_mat, d_labels, n_clusters, cfg, stream_);
...
TEST_F(TtestDE, Ttest_DeterminismFlag_BitIdentical) {
    ...
    singlet_gpu::de::TtestResult r1 =
        singlet_gpu::de::ttest_de(d_mat, d_labels, kTinyClusters, cfg, stream_);
    singlet_gpu::de::TtestResult r2 =
        singlet_gpu::de::ttest_de(d_mat, d_labels, kTinyClusters, cfg, stream_);
...
TEST_F(TtestDE, Ttest_EdgeCase_EmptyCluster) {
    ...
    singlet_gpu::de::TtestResult result;
    ASSERT_NO_THROW(
        result = singlet_gpu::de::ttest_de(
...
TEST_F(TtestDE, Ttest_EdgeCase_SingleCluster) {
    ...
    singlet_gpu::de::TtestResult result;
    ASSERT_NO_THROW(
        result = singlet_gpu::de::ttest_de(d_mat, d_labels, 1, cfg, stream_));
