...
//
// Correctness harness for singlet_gpu::fate::palantir.
//
...
TEST(Palantir, TinySynthetic_VsPython) {
    ...
    singlet_gpu::core::DeviceMemory<float> d_X(
    ...
    singlet_gpu::fate::PalantirResult res =
        singlet_gpu::fate::run_palantir(ctx, d_X, kTinyCells, kTinyGenes, cfg);
...
TEST(Palantir, GSM_RealData) {
    ...
    singlet_gpu::fate::PalantirResult res =
        singlet_gpu::fate::run_palantir_from_csc(ctx, d_csc, cfg);
