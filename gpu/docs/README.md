...
A bare-metal cuBLAS / cuSPARSE / cuSOLVER GPU library for single-cell analysis. Reads singlify `.1pz` outputs zero-copy, runs the entire foundational EDA workflow on device, scales out-of-core to billion cells.
